...
public interface PriorityQueue {
	...
	/**
	 * Returns a String representation of the heap with the values in the same
	 * order they appear in the array. The format should be "[5, 8, 10]" for example.
	 * Your String representation should not include any "empty" indices in your heap
	 * array.
	 *
	 * @return a String representation of our heap
	 */
